...
export const GithubIcon = ({ className, ...rest }) => (
  ...
  >
    ...
    <path
      className="fill-dark dark:fill-light lg:fill-light lg:dark:fill-dark transition-all delay-[600ms] dark:transition-all dark:delay-[700ms]"
...
export const GithubIconSmall = ({ className, ...rest }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
  ...
  >
    <path fill="none" d="M0 0h512v512H0z" />
    <path
      className="fill-dark dark:fill-light transition-all delay-[600ms] dark:transition-all dark:delay-[700ms]"
      d="M256 32C132.3 32 32 134.9 32 261.7c0 101.5 64.2 187.5 153.2 217.9a17.56 17.56 0 0 0 3.8.4c8.3 0 11.5-6.1 11.5-11.4 0-5.5-.2-19.9-.3-39.1a102.4 102.4 0 0 1-22.6 2.7c-43.1 0-52.9-33.5-52.9-33.5-10.2-26.5-24.9-33.6-24.9-33.6-19.5-13.7-.1-14.1 1.4-14.1h.1c22.5 2 34.3 23.8 34.3 23.8 11.2 19.6 26.2 25.1 39.6 25.1a63 63 0 0 0 25.6-6c2-14.8 7.8-24.9 14.2-30.7-49.7-5.8-102-25.5-102-113.5 0-25.1 8.7-45.6 23-61.6-2.3-5.8-10-29.2 2.2-60.8a18.64 18.64 0 0 1 5-.5c8.1 0 26.4 3.1 56.6 24.1a208.21 208.21 0 0 1 112.2 0c30.2-21 48.5-24.1 56.6-24.1a18.64 18.64 0 0 1 5 .5c12.2 31.6 4.5 55 2.2 60.8 14.3 16.1 23 36.6 23 61.6 0 88.2-52.4 107.6-102.3 113.3 8 7.1 15.2 21.1 15.2 42.5 0 30.7-.3 55.5-.3 63 0 5.4 3.1 11.5 11.4 11.5a19.35 19.35 0 0 0 4-.4C415.9 449.2 480 363.1 480 261.7 480 134.9 379.7 32 256 32Z"
    />
  </svg>
);
...
export const TwitterIcon = ({ className, ...rest }) => (
  ...
  >
    ...
    <path className="fill-dark dark:fill-light lg:fill-light lg:dark:fill-dark transition-all delay-500 dark:transition-all dark:delay-[800ms]"
...
export const LinkedInIcon = ({ className, ...rest }) => (
  <svg
    ...
    className={`w-full h-auto ${className}`}
  >
    <path className="fill-dark dark:fill-light lg:fill-light lg:dark:fill-dark transition-all delay-[700ms] dark:transition-all dark:delay-[600ms]"
...
export const InstagramIcon = ({ className, ...rest }) => (
  <svg
    ...
    className={`w-full h-auto ${className}`}
  >
    <path className="fill-dark dark:fill-light lg:fill-light lg:dark:fill-dark transition-all delay-[800ms] dark:transition-all dark:delay-[500ms]"
...
// export const Messangger = ({ className, ...rest }) => (
...
//       </rect>
//       <path className="fill-dark dark:fill-light" d="M656,51.334C648.748,46.634 644,38.828 644,30C644,15.65 656.546,4 672,4C687.454,4 700,15.65 700,30C700,44.35 687.454,56 672,56C670.119,56 668.282,55.827 666.504,55.498C666.504,55.498 660.251,58.178 657.394,59.403C657.085,59.535 656.73,59.503 656.45,59.318C656.169,59.133 656,58.82 656,58.483C656,55.999 656,51.334 656,51.334Z" transform="translate(-640)">
//       </path>
//       <path className="fill-light dark:fill-dark" d="M652,36C652,36 664.034,25.47 667.229,22.675C667.432,22.497 667.698,22.409 667.966,22.43C668.235,22.451 668.483,22.58 668.656,22.787C670.88,25.456 678,34 678,34L692,28C692,28 679.966,38.53 676.771,41.325C676.568,41.503 676.302,41.591 676.034,41.57C675.765,41.549 675.517,41.42 675.344,41.213C673.12,38.544 666,30 666,30L652,36Z" transform="translate(-640 -2)">
//       </path>
//     </g>
//   </svg>
// );
