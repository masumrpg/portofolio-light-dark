...
export const GithubIcon = ({ className, ...rest }) => (
  ...
  >
    ...
    <path
      className="fill-dark dark:fill-light transition-all delay-[600ms] dark:transition-all dark:delay-[600ms]"
...
export const TwitterIcon = ({ className, ...rest }) => (
  ...
  >
    ...
    <path className="fill-dark dark:fill-light transition-all delay-500 dark:transition-all dark:delay-500"
...
export const LinkedInIcon = ({ className, ...rest }) => (
  <svg
    ...
    className={`w-full h-auto ${className}`}
  >
    <path className="fill-dark dark:fill-light transition-all delay-[700ms] dark:transition-all dark:delay-[700ms]"
...
export const InstagramIcon = ({ className, ...rest }) => (
  <svg
    ...
    className={`w-full h-auto ${className}`}
  >
    <path className="fill-dark dark:fill-light transition-all delay-[800ms] dark:transition-all dark:delay-[800ms]"
