...
export const HireMe = () => {
  return (
    ...
    overflow-hidden md:bottom-auto md:left-auto md:top-0 md:absolute z-20">
      <div className="w-48 h-auto flex items-center justify-center relative md:w-24 group">
        <CircularText
          className={"fill-dark dark:fill-light animate-pulse duration-200 group-hover:animate-spin-slow"}
        />
        <Link
