    ...
    <>
      ...
      >
        <Layout className="pt-16">
          ...
          <h2 className="font-bold text-4xl w-full text-center mb-14">
            Contact Me
          </h2>
          ...
          <div className="flex gap-[4rem] justify-center md:flex-col md:mx-10">
            ...
            {emailSent ? <EmailSent /> : (
              <form ref={form} onSubmit={sendEmail} className="flex flex-col gap-[1.2rem] items-center md:mx-10">
                <input className="w-[30rem] p-4 py-2 rounded-xl sm:flex-col bg-light text-dark first:mt-0 border border-solid border-dark
                border-r-4 border-b-4 dark:bg-dark dark:border-light dark:text-light sm:w-[15rem]"
                  type="text" name='name' placeholder='Nama Full' required />
                <input className="w-[30rem] p-4 py-2 rounded-xl sm:flex-col bg-light text-dark first:mt-0 border border-solid border-dark
                border-r-4 border-b-4 dark:bg-dark dark:border-light dark:text-light sm:w-[15rem]" type="email" name='email' placeholder='Email Kamu' required />
                <textarea className="w-[30rem] p-4 py-2 rounded-xl sm:flex-col bg-light text-dark first:mt-0 border border-solid border-dark
                border-r-4 border-b-4 dark:bg-dark dark:border-light dark:text-light sm:w-[15rem]" name="message" rows="7" placeholder='Masukan Pesan Kamu' required />
